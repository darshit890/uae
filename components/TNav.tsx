...
export const TNav = () => {
  return (
    <section className='border-b'>
        <div className='h-9  flex flex-row justify-between mx-auto md:pl-8 px-4 max-w-7xl'>
